  ...
  return (
    <>
      <div
        ...
        ref={centerRef}
        className="box-border w-full h-screen min-h-screen flex flex-col will-change-transform justify-center items-center text-white tracking-[-0.04em] leading-[90%] gap-8 px-4 md:px-8 lg:px-12 relative"
      >
