  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center justify-center gap-12 px-4 md:px-8 lg:px-12 mx-auto">
        <div>
          <p className="text-5xl md:text-7xl lg:text-9xl white-silver-animated-text text-center">
            We are not an AI
          </p>
          <div className="h-16 md:h-20 lg:h-32 flex w-full flex-row items-center">
            <RotatingText />
          </div>
          <p className="text-5xl md:text-7xl lg:text-9xl w-full white-silver-animated-text1 text-center">
            Company
          </p>
        </div>
