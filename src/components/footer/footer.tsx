    ...
    return (
        <>
            <div
                id="footer-section"
                ref={footerRef}
                className="w-full h-screen min-h-screen flex flex-col will-change-transform justify-between items-center text-white tracking-[-0.04em] leading-[90%] pt-6 sm:pt-4 lg:pt-6 bg-cyan-700 sm:bg-amber-600 md:bg-blue-700 lg:bg-fuchsia-800 overflow-hidden"
            >
