    ...
    return (
        <>
            <div
                id="footer-section"
                ref={footerRef}
                className="w-full h-[95dvh] min-h-screen flex flex-col will-change-transform justify-between items-center text-white tracking-[-0.04em] leading-[90%] pt-6 sm:pt-4 lg:pt-6 overflow-hidden"
            >
